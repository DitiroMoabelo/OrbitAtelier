...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ws(e,t,n){let r=new Float32Array(As),i=new q(0,1,0);return new oo({name:`SphericalGaussianBlur`,defines:{n:As,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:qs(),fragmentShader:`
	...
	`}var Js=class extends Wt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Si(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var yl={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function bl(e,t){let n=yl[t];return n===void 0?(U(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var xl=new q;function Sl(){return Y.getLuminanceCoefficients(xl),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${xl.x.toFixed(4)}, ${xl.y.toFixed(4)}, ${xl.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=dl(i,i.VERTEX_SHADER,y),S=dl(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1){if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=_l(i,x,`vertex`),n=_l(i,S,`fragment`);W(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `}));e.add(t);let n=new qr(new Oi(12,64),new co({color:new X(`#F3E2D4`),roughness:.85,metalness:.02}));n.rotation.x=-Math.PI/2,n.position.y=-3.2,n.receiveShadow=!0,e.add(n);let r=new qr(new Oi(4.2,64),new co({color:new X(`#F7C7D3`),roughness:1,metalness:0,transparent:!0,opacity:.35}));return r.rotation.x=-Math.PI/2,r.position.y=-3.18,r.scale.set(1.4,1,1),e.add(r),e}function Fu(e=140){let t=new Float32Array(e*3),n=new Float32Array(e);for(let r=0;r<e;r++)t[r*3]=(Math.random()-.5)*10,t[r*3+1]=Math.random()*6-1.5,t[r*3+2]=(Math.random()-.5)*8,n[r]=Math.random()*Math.PI*2;let r=new wr;r.setAttribute(`position`,new ur(t,3)),r.setAttribute(`aPhase`,new ur(n,1));let i=new bi(r,new hi({color:new X(`#FFFFFF`),size:.035,transparent:!0,opacity:.45,depthWrite:!1,blending:2,sizeAttenuation:!0}));return i.name=`dust`,i.userData.phases=n,i}function Iu(e,t){let n=e.geometry.getAttribute(`position`),r=e.userData.phases;for(let e=0;e<n.count;e++){let i=r[e],a=(n.getY(e)+Math.sin(t*.35+i)*.002+1.5)%6-1.5;n.setY(e,a),n.setX(e,n.getX(e)+Math.sin(t*.2+i)*.0015)}n.needsUpdate=!0}function Lu(e,t){return new oo({uniforms:{uColor:{value:new X(e)},uAccent:{value:new X(t)},uTime:{value:0},uGlow:{value:0}},vertexShader:`
      varying vec3 vNormal;
      varying vec3 vView;
      void main() {
